...
echo "=========================================="
echo "  请映射容器端口: -p 8080:8080"
echo "  访问入口: http://<your-ip>:8080/"
echo "  Code-Server: http://<your-ip>:8080/code/"
echo "  JupyterLab:  http://<your-ip>:8080/jupyter/"
echo "  API:        http://<your-ip>:8080/v1/messages"
